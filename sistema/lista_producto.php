...
<head>
	...
	<title>Lista de Productos | PanMello</title>
</head>
<body>
        ...
        <table>
            <tr>
                ...
                //Paginador
                  ...
                  $query = mysqli_query($conection, "SELECT * FROM producto WHERE estatus = 1 ORDER BY idproducto DESC LIMIT $desde,$por_pagina");
